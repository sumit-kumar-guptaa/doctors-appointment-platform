...
export const creditBenefits = [
  "Each consultation requires <strong class='text-orange-400'>2 credits</strong> regardless of duration",
  "Credits <strong class='text-orange-400'>never expire</strong> - use them whenever you need",
  "Monthly subscriptions give you <strong class='text-orange-400'>fresh credits every month</strong>",
  "Cancel or change your subscription <strong class='text-orange-400'>anytime</strong> without penalties",
];
